bl_info = {
    "name" : "Wardrobe",
    "description" : "Injects cosmetics into your scene. Make sure you have The TF2 Collection added as asset libraries!",
...
def returnsearch(a):
    ...
    cln = ["named", "unnamed"]
    f = open(r"C:\Users\Javiers\Documents\master.json")
...
class AddLightwarps(bpy.types.Operator): # switch to lightwarps with a button
    ...
    def execute(self, context):
        ...
        return {'FINISHED'}
classes.append(AddLightwarps)

class RemoveLightwarps(bpy.types.Operator): # be cycles compatible
...
classes.append(RemoveLightwarps)
...
class Search(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bpy.utils.register_class(PART2)
...
class ClearSearch(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        try:
            bpy.utils.unregister_class(bpy.types.PART2)
            return {'FINISHED'}
        except:
            pass
            return {'CANCELLED'}
